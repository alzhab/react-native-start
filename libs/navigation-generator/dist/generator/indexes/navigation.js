...
function generateNavigationIndex(indexFilePath, routes, parent, type = types_1.NavigationsType.stack) {
    return __awaiter(this, void 0, void 0, function* () {
        const source = getNavigationSource(type);
        const template = handlebars_1.default.compile(source);
        const contents = template({ routes, parent });
        yield fs_1.default.writeFile(indexFilePath, contents, (err) => {
            if (err)
